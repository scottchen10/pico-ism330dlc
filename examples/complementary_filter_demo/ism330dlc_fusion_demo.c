...
void main() 
{
    ...
    while (true) {
        ...
        printf("----------------------------------------------\n");
        printf("Temperature        :   %5.2f                 Celcius \n", temp);
        printf("Accelerometer Data : [ %5.2f, %5.2f, %5.2f ] m/s \n", accel_data.x, accel_data.y, accel_data.z);
        printf("Gyroscope Data     : [ %5.2f, %5.2f, %5.2f ] rad/s \n", gyro_data.x, gyro_data.y, gyro_data.z);
        printf("Fused Orientation  : [ %5.2f, %5.2f, %5.2f ] degrees \n", 
